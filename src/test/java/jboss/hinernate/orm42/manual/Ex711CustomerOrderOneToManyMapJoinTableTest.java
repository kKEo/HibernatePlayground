 ...
 *         orders_key varchar(255) not null,
 *         primary key (customer_id, orders_key)
 *     )
 * </pre>
 */
public class Ex711CustomerOrderOneToManyMapJoinTableTest extends HibernateBaseTestUsingProgrammableConfig {
	...
	public static class Customer {
		...
		@OneToMany
		@JoinTable(name = "Cust_Order", joinColumns = @JoinColumn(name = "customer_id") //
		)
		@MapKeyColumn(name = "orders_key")
